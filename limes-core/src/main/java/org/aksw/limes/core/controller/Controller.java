...
public class Controller {
    ...
    private static void execute(CommandLine cmd) {
       ...
       // HybridCache targetCache = HybridCache.getData(config.getTargetInfo());
        ...
        MemoryCache sourceCache = new MemoryCache();//HybridCache.getData(config.getSourceInfo());
        MemoryCache targetCache = new MemoryCache();//HybridCache.getData(config.getTargetInfo());
