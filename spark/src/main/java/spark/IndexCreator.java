...
public class IndexCreator {
	...
	/**
	 * @param resourcesRDD : RDD in the form of (r_id, [info])
	 * @param skbB : source KBInfo
	 * @param tkbB : target KBInfo
	 * @return tokenPairs in the form of (token, r_id)
	 */
	public static JavaPairRDD<String, String> getTokenPairs(JavaPairRDD<String,List<String>> resourcesRDD,
																  ...
																  final Broadcast<byte[]> tkbB)
	{
					...
					/*for(int i = 0; i < r_info.size()-1; i = i + 2){
						...
						//if(kbProperties.contains(predicate)){
							...
							for (int j = 0; j < tokens.length; j++) {
								...
								t = new Tuple2<String,String>(tokens[j],r_id);
								tokenPairs.add(t);
							}
						//}
					}*/
		...
		JavaPairRDD<String, String> result = resourcesRDD.mapPartitionsToPair(f);
		return result;
	}
